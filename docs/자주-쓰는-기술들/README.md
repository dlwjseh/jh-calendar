...
기능별 단계 문서(`docs/01-...` 등)와 달리, **자주 마주치는 Swift / SwiftUI 개념을 한 곳에 모아둔 레퍼런스**.

특정 기능을 만들다 막혔을 때 빠르게 찾아볼 용도. 단계 md 안에서도 `[[...]]` 식으로 이쪽을 링크하면 같은 설명을 반복하지 않을 수 있다.
...
- [그림자](그림자.md) — `.shadow(...)` 파라미터, 모디파이어 순서, 프로젝트의 두 가지 프리셋(가벼움/강함)
